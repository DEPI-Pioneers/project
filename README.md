...
|-------------|------|-----------------|
| [**Abdulrahman Hakim**](https://www.linkedin.com/in/abdelrahman-hakim) | Team Leader & Data Analyst &business analysis & dashboard | - Led the entire project, including data analysis, KPI development, and dashboard creation.  <br> - Handled data preprocessing, transformation, and performed all statistical analysis.  <br> - Designed and developed the Power BI dashboard, focusing on business insights and customer segmentation.  <br> - Delivered the final business analysis and project presentation. |
